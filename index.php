...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="https://use.typekit.net/lnp1vtw.css">
...
<body>
    ...
    <div class="portfolio-section" id="portfolio">
        <div class="header-container">
            ...
            <div class="divider">
                ...
                <svg class="svg-inline--fa fa-star dark" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <div class="projects-container">
            <div class="project">
                <img src="./assets/cabin.png" alt="cabin">
                <div class="plus">+</div>
            </div>
            <div class="project">
                <img src="./assets/cake.png" alt="cabin">
                <div class="plus">+</div>
            </div>
            <div class="project">
                <img src="./assets/circus.png" alt="cabin">
                <div class="plus">+</div>
            </div>
            <div class="project">
                <img src="./assets/game.png" alt="cabin">
                <div class="plus">+</div>
            </div>
            <div class="project">
                <img src="./assets/safe.png" alt="cabin">
                <div class="plus">+</div>
            </div>
            <div class="project">
                <img src="./assets/submarine.png" alt="cabin">
                <div class="plus">+</div>
            </div>
        </div>
    </div>
    ...
    <div class="contactme-section" id="contact">
        <div class="header-container">
            <h1>CONTACT ME</h1>
            <div class="divider">
                <div class="line dark"></div>
        ...
        <div class="contact-container">
            <form action="./backend/form-validation.php" method="post">
                <p id="form-result" data-role=""></p>
                ...
                <div class="input-container">
                    <input type="tel" required id="tel-input">
                ...
                <div class="input-container">
                    <textarea required id="message-input"></textarea>
        ...
        <a href="messages.html" style="margin-top: 30px;">Check messages table</a>
    </div>
    <div class="info-section">
        <div class="location info">
            <h2>LOCATION</h2>
            <h3>2215 John Daniel Drive <br />
                Clark, MO 65243</h3>
        </div>
        <div class="web info">
            ...
            <div class="socials">
                <div class="faceboook ">
                    <svg class="svg-inline--fa fa-facebook-f fa-fw social" aria-hidden="true" focusable="false"
                ...
                <div class="twitter ">
                    <svg class="svg-inline--fa fa-twitter fa-fw social" aria-hidden="true" focusable="false"
                ...
                <div class="linkedin ">
                    <svg class="svg-inline--fa fa-linkedin-in fa-fw social" aria-hidden="true" focusable="false"
                ...
                <div class="dribbble ">
                    <svg class="svg-inline--fa fa-dribbble fa-fw social" aria-hidden="true" focusable="false"
        ...
        <div class="freelance info">
            ...
            <h3>Freelance is a free to use, MIT licensed Bootstrap theme created by <a
